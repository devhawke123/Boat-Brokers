...
export default function BlogHero() {
  return (
    ...
    >
      ...
      <div className="relative z-[5] flex max-w-[43.75rem] flex-col items-center gap-4">
        <h1 className="font-display text-[44px] leading-[1.2] tracking-[-1.6px] text-white capitalize sm:text-[5rem]">
          Blog
        </h1>
        <p className="max-w-[43.75rem] text-sm leading-[1.5] tracking-[-0.32px] text-[#ededed] sm:text-base">
          Explore expert knowledge, thoughtful guidance and essential insights for navigating the
          world of narrowboats with confidence.
        </p>
      </div>
    </section>
  )
