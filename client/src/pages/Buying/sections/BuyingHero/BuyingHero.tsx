    ...
    >
      ...
      <div className="relative z-[5] flex max-w-[43rem] flex-col items-center gap-6">
        ...
        <p className="max-w-[35rem] text-base leading-[26px] text-[#ededed] sm:text-xl sm:leading-[30px]">
          Buying a boat doesn&rsquo;t have to be complicated. From finding the right boat to
          completing the purchase, we&rsquo;re here to guide you through every step.
        </p>
      </div>
    </section>
  )
