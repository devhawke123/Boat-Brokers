...
const rows: { items: ReactNode[]; image: string; imageAlt: string; textFirst: boolean }[] = [
  {
    items: [
      <>
        ...
        <a
          ...
          className="underline"
        >
          narrowboat broker Wolverhampton
        </a>{' '}
        covering the BCN, Staffordshire &amp; Worcestershire and Shropshire Union corridors
      </>,
    ...
    image: image1,
    imageAlt: 'A narrowboat moored on a canal near Wolverhampton at sunset',
    textFirst: true,
  },
  {
    items: [
      'Strong buyer database actively searching for vessels in the Wolverhampton area',
      'No upfront fees, you pay only when your boat sells',
    ],
    image: image2,
    imageAlt: 'A narrowboat moored on a canal near Wolverhampton',
    textFirst: false,
  },
]

export default function WolverhamptonWhyChoose() {
  return (
    <section className="flex flex-col items-center gap-12 rounded-2xl bg-navy-darkest px-6 py-14 sm:gap-16 sm:px-16 sm:py-20">
      <div className="flex w-full max-w-[80rem] flex-col gap-6">
        ...
        <h2 className="font-display text-[2.375rem] leading-[1.3] tracking-[-2px] text-white capitalize sm:text-[3.375rem]">
          Why Choose The Boat Brokers in Wolverhampton?
        </h2>
        <p className="max-w-[62rem] text-base leading-[26px] text-[#e3e3e3]">
          We are a dedicated narrowboat and canal boat brokerage with strong knowledge of the
          Wolverhampton waterway market. Wolverhampton sellers benefit from a buyer database that
          covers three distinct canal audiences — BCN buyers, Staffordshire and Worcestershire
          cruisers, and Shropshire Union enthusiasts — which gives your listing a broader reach
          than a purely local or single-waterway brokerage can offer.
        </p>
      </div>
