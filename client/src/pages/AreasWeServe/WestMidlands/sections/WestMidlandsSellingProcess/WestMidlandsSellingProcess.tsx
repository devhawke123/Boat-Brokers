    ...
    <section className="flex flex-col items-center gap-12 px-6 py-16 sm:px-16 sm:py-24">
      ...
      <div className="flex w-full flex-col items-center gap-5 lg:hidden">
        <div className="flex w-full flex-col items-start gap-2">
          <span className="inline-flex items-center gap-2 rounded-full bg-[#e3f7fe] px-4 py-1.5 text-[0.625rem] font-medium tracking-[0.7px] text-[#14b2ef] uppercase">
          ...
          <div className="mt-2 flex items-center gap-3 text-xs tracking-[0.5px] text-blue uppercase">
            ...
            <svg
              ...
              fill="none"
              aria-hidden="true"
              className="h-3.5 w-32 text-black"
            >
              <path
        ...
        <div className="-mx-3 flex w-[calc(100%+1.5rem)] flex-col divide-y divide-[#d0c7c7] rounded-2xl border border-[#d0c7c7]">
