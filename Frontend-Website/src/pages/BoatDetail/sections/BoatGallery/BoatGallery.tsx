  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="relative h-[300px] w-full overflow-hidden rounded-lg bg-navy-darkest shadow-[0px_10px_40px_-10px_rgba(11,58,88,0.08)] sm:h-[380px] lg:h-[478px]">
        ...
        <div className="pointer-events-none absolute top-section-y left-section-x">
          <span
        ...
        <div className="pointer-events-none absolute right-section-x bottom-section-y left-section-x flex flex-wrap items-end justify-between gap-4">
