...
const rows: { items: ReactNode[]; image: string; imageAlt: string; textFirst: boolean }[] = [
  {
    items: [
      <>
        ...
        covering the full county waterway network
      </>,
      'Real transaction data from the local Worcestershire market',
  ...
  {
    items: [
      'Business built primarily on personal recommendation',
...
export default function WorcestershireWhyChoose() {
  return (
    <section className="flex flex-col items-center gap-12 rounded-2xl bg-navy-darkest px-6 py-14 sm:gap-16 sm:px-16 sm:py-20">
      <div className="flex w-full max-w-[80rem] flex-col gap-6">
        ...
        <h2 className="font-display text-[2.375rem] leading-[1.3] tracking-[-2px] text-white capitalize sm:text-[3.375rem]">
          Why Choose The Boat Brokers in Worcestershire?
        </h2>
        <p className="max-w-[62rem] text-base leading-[26px] text-[#e3e3e3]">
          We are a specialist narrowboat and canal boat brokerage, not a general sales agent. The
          Worcestershire waterway market is one we know well — and the Worcester &amp; Birmingham
          Canal and the Staffordshire &amp; Worcestershire are consistently among the most
          searched waterways in our buyer database. That means the right buyers are already
          looking when your listing goes live.
        </p>
      </div>
