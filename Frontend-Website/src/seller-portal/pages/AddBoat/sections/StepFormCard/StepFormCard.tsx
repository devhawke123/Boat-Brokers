...
import saveDraftIcon from '../../../../assets/AddBoat/save-draft-icon.svg'
...
export default function StepFormCard({
  ...
  return (
    <div className="flex h-fit w-full flex-col gap-6 rounded-xl border border-[#e2e8f0] bg-white lg:flex-1">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 px-8 pt-4 pb-8">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <img src={saveDraftIcon} alt="" aria-hidden="true" className="h-3.5 w-2.5" />
            Save as Draft
          </button>
          <button
            type="button"
            onClick={onContinue}
            className="flex items-center gap-2 rounded-lg bg-[#0b3a58] px-8 py-2.5 text-[14px] font-semibold tracking-[0.068px] text-white shadow-[0px_10px_15px_-3px_#dbeafe,0px_4px_6px_-4px_#dbeafe]"
          >
            {continueLabel}
