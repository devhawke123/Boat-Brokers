...
import { AddBoatIcon, CloseIcon, CommentsIcon, DashboardIcon, HelpIcon, LogoutIcon, MyBoatsIcon, ProfileIcon } from './icons'
  ...
  const sections: NavSection[] = [
    {
      ...
      items: [
        ...
        { label: 'My Boats', href: '/seller-portal/my-boats', icon: MyBoatsIcon },
        { label: 'Add New Boat', href: '/seller-portal/boats/new', icon: AddBoatIcon },
      ],
    },
    {
      label: 'Communication',
      items: [{ label: 'Comments', href: '/seller-portal/comments', icon: CommentsIcon }],
    },
    {
      label: 'System',
      items: [
