...
const navLinks: NavLink[] = [
  ...
  { label: 'Boats for Sale', href: '/boats-for-sale' },
  {
    ...
    hasDropdown: true,
    dropdownItems: [
      { label: 'The Buying Process', href: '/buying#buying-process' },
      { label: 'Should I Have a Survey?', href: '/buying#survey' },
      { label: 'Do I Need to Insure My Boat?', href: '/buying#insurance' },
      { label: 'Do I Need a Licence?', href: '/buying#licence' },
      { label: 'Can I Get Finance?', href: '/buying#finance' },
      { label: 'Ask a Question?', href: '/buying#ask-a-question' },
    ],
  },
  {
    label: 'Selling',
    ...
    hasDropdown: true,
    dropdownItems: [
      { label: 'The Selling Process', href: '/selling#selling-process' },
      ...
      <div className="flex items-center justify-between gap-3 px-4 py-3 2xl:gap-6 2xl:px-5">
        ...
        <div className="flex shrink-0 items-center gap-2 max-nav:hidden 2xl:gap-4">
          <Button
            ...
            href="/boats-for-sale"
          />
          <Button variant="light" label="Seller Portal" sublabel="Manage Your Boats" href="/seller-portal/login" />
        </div>
