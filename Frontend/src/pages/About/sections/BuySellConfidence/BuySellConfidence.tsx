    ...
    <section className="py-14 lg:py-16">
      <div className="mx-auto flex max-w-[87.5rem] flex-col gap-14 lg:gap-12">
        <div className="flex flex-col gap-6 lg:gap-4">
          ...
          <h2 className="font-display text-[2.125rem] leading-[1.2] tracking-[-2px] text-black capitalize sm:max-w-[43rem] sm:text-[2.375rem] sm:leading-[1.3] lg:text-[3.375rem] lg:leading-[1.2]">
            Buy or Sell Your
        ...
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="order-1 flex flex-col gap-8 lg:order-2 lg:gap-6">
            <div className="flex flex-col gap-6 lg:gap-4">
              ...
              <p className="text-sm leading-[26px] text-text-body sm:text-lg lg:text-xl lg:leading-[32px]">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex flex-1 flex-col gap-2">
                <p className="font-accent text-xl text-[#1a1a1a] lg:text-2xl">For Buyers</p>
                <p className="text-sm leading-[1.5] font-light text-text-body sm:text-base lg:leading-[1.6]">
